...
**SENSAAS-Bioisostere** is an add-on of [SENSAAS](https://github.com/SENSAAS/sensaas-py) and [SENSAAS-Flex](https://github.com/SENSAAS/sensaas-flex) that specifically replaces a query fragment by a new molecular fragment extracted from known bioactive molecules.
...
Figure: the second fragment is shown in magenta
